...
const LANGS = {
  ...
  tr: {
    ...
    ui: {
      ...
      recAmountLabel:'Tutar', recFrequencyLabel:'Ne Sıklıkla?',
      freqMonthly:'Her Ay', freqEvery2:'2 Ayda Bir', freqEvery3:'3 Ayda Bir',
      freqEvery4:'4 Ayda Bir', freqEvery6:'6 Ayda Bir', freqYearly:'Yılda Bir',
      recFreqLabel:(n)=>{n=parseInt(n)||1;if(n<=1)return'Her ay';if(n===12)return'Yılda bir';return n+' ayda bir';},
      notDueThisMonth:'Bu ay sırada değil',
      nextDueInMonths:(n)=>n===1?'Gelecek ay ödenecek':`${n} ay sonra ödenecek`,
      ...
      instCountLabel:'Taksit Sayısı', instDayLabel:'Hesap Kesim Günü',
      instDayHint:'Taksitler kartın hesap kesim tarihinde işlenir, bu tarih Kart Bilgileri\'nden değiştirilebilir.',
      instDayHintPrefix:'Kesim günü:', installmentNextChargePrefix:'Sıradaki kesim:',
      ...
      notifBlockedMsg:'Bildirim izni cihaz ayarlarından kapatılmış. Tekrar açmak için aşağıdaki adımları izleyin.',
      notifBlockedStepsTitle:'Nasıl açılır:',
      notifBlockedStep1:'1. Cihaz Ayarları → Uygulamalar → SAGI Finance',
      notifBlockedStep2:'2. Bildirimler\'e dokunun, izni açın',
      notifBlockedStep3:'3. Uygulamaya geri dönün',
      notifPrimeMsg:'SAGI Finance size yaklaşan ödemeler, abonelikler ve bütçe aşımları için hatırlatma gönderebilir. Bildirimlere izin vermek ister misiniz? Dilediğiniz zaman Ayarlar\'dan kapatabilirsiniz.',
      notifPrimeYes:'Evet, Bildirimleri Aç', notifPrimeLater:'Belki Sonra',
      ...
      confFactory:'<strong style=\"color:var(--status-danger)\">Bu işlem geri alınamaz.</strong><br><br><strong>Silinecekler:</strong><br>• Tüm işlemler, hesaplar, abonelikler, hedefler, borçlar<br>• Bu cihazdaki yerel veriler<br>• Bulut anahtarınıza bağlı tüm veriler<br><br><span style=\"color:var(--text-muted);font-size:13px\"><strong>Not:</strong> Anahtarınız silinmez; ancak içindeki tüm veriler gider. Anahtarı başka cihazda kullansanız bile veriler kurtarılamaz.</span><br><br>Devam etmek istiyor musunuz?',
      ...
      confCloudCreate:'Mevcut yerel verileriniz anonim bir anahtarla Firebase\'e yüklenecek ve senkronizasyon başlayacak.\n\n Anahtarınızı kaydedin — kaybederseniz bulut verilerinize bir daha erişemezsiniz.\n\nGizlilik Politikamızda belirttiğimiz üzere kimlik bilgisi toplanmaz. Devam etmek istiyor musunuz?',
      confCloudSignOut:'Bu cihazdan bulut bağlantısı kesilecek. Verileriniz bu cihazda kalmaya devam eder. Devam?',
      confFullLogout:'<strong style="color:var(--status-danger)">Çıkış yapılacak ve bu cihazdaki tüm yerel veriler silinecek.</strong><br><br>Bulut anahtarınız ve içindeki veriler <strong>silinmez</strong> — anahtarınızı not aldıysanız, istediğiniz zaman "Mevcut Anahtarla Bağlan" ile geri dönebilirsiniz.<br><br>Devam etmek istiyor musunuz?',
      fullLogoutDone:'Çıkış yapıldı, cihaz sıfırlandı.',
      keyNotFoundTitle:'Bulut Anahtarı Bulunamadı',
      keyNotFoundDesc:'Bu cihaza kayıtlı bulut anahtarı Firebase\'de bulunamadı. Hesap silinmiş veya başka bir yerden kaldırılmış olabilir. Devam edebilmek için bu cihazdaki bağlantıyı kaldırmanız gerekiyor.',
      keyNotFoundBtn:'Çıkış Yap',
      ...
      confCloudConnectBothHaveData:'Bu hesapta da veri var. Bağlanırsan <strong>bu cihazdaki mevcut veriler silinir</strong> ve hesabın verisi yüklenir. Devam etmek istiyor musun?',
      ...
      payoffTimelineTitle:'Taksit/Borç Ödeme Takvimi',
      payoffTimelineSubtitle:'Önümüzdeki 6 ayda kredi kartı taksit yükünün nasıl azalacağı',
      payoffNoInstallments:'Aktif taksit yok — grafik gösterilecek bir şey bulunmuyor.',
      payoffMonthlyBurden:'Aylık Taksit Yükü',
      payoffMonthlyBurdenNow:'Bu Ayki Taksit Yükü',
      payoffRemainingInstallments:'Kalan Taksit Toplamı',
      payoffTotalDebt:'Toplam Borç',
      forecastNet:'Net', forecastProjectedSuffix:'tahmin',
      netWorthTrendTitle:'Net Değer Trendi',
      netWorthTrendSubtitle:'Hesaplarınızdaki toplam varlığın zaman içindeki değişimi',
      netWorthTrendSeriesLabel:'Toplam Varlık',
      netWorthTodayLabel:'Bugünkü Net Değer',
      netWorthTodayHint:'Toplam varlık, borç ve kalan taksitler düşülerek hesaplanır. Grafik sadece varlıkları (cüzdan bakiyelerini) gösterir; geçmiş borç seviyesi güvenilir şekilde yeniden inşa edilemediği için grafiğe dahil edilmez.',
      burdenSummaryTitle:'Sabit Yük ve Anomali Özeti',
      burdenSummarySubtitle:'Abonelik ve taksit yükünüz, olağandışı kategori harcamaları',
      burdenTotalLabel:'Aylık Sabit Yük', burdenOfIncome:'gelirin',
      anomalyTitle:'Olağandışı Harcamalar',
      anomalyNone:'Bu ay olağandışı bir kategori harcaması tespit edilmedi.',
      anomalyRowText:(vars)=>`${vars.cat}: son 3 ay ortalamasının %${vars.pct} üzerinde`,
      weekdayPatternTitle:'Haftanın Günü Paterni', weekdayPatternHint:'Hangi günler daha çok harcıyorsunuz',
      weekdayShortNames:'Pzt,Sal,Çar,Per,Cum,Cmt,Paz',
      biggestTxTitle:'En Büyük Harcamalar', biggestTxHint:'Bu dönemin en büyük 8 işlemi',
      ...
      notifSettingsBtn:'Bildirim Ayarları',
      ...
      obConsentSuffix:'\'nı okudum, kabul ediyorum. 18 yaşını doldurduğumu beyan ederim.',
  ...
  en: {
    ...
    ui: {
      ...
      recAmountLabel:'Amount', recFrequencyLabel:'How Often?',
      freqMonthly:'Monthly', freqEvery2:'Every 2 Months', freqEvery3:'Every 3 Months',
      freqEvery4:'Every 4 Months', freqEvery6:'Every 6 Months', freqYearly:'Yearly',
      recFreqLabel:(n)=>{n=parseInt(n)||1;if(n<=1)return'Monthly';if(n===12)return'Yearly';return'Every '+n+' months';},
      notDueThisMonth:'Not due this month',
      nextDueInMonths:(n)=>n===1?'Due next month':`Due in ${n} months`,
      ...
      instCountLabel:'Number of Installments', instDayLabel:'Statement Cutoff Day',
      instDayHint:'Installments are charged on the card\'s statement cutoff date, which can be changed from Card Details.',
      instDayHintPrefix:'Cutoff day:', installmentNextChargePrefix:'Next charge:',
      ...
      notifBlockedMsg:'Notification permission was turned off in device settings. Follow the steps below to turn it back on.',
      notifBlockedStepsTitle:'How to enable:',
      notifBlockedStep1:'1. Device Settings → Apps → SAGI Finance',
      notifBlockedStep2:'2. Tap Notifications, turn the permission on',
      notifBlockedStep3:'3. Come back to the app',
      notifPrimeMsg:'SAGI Finance can remind you about upcoming payments, subscriptions, and budget overruns. Would you like to enable notifications? You can turn them off anytime from Settings.',
      notifPrimeYes:'Yes, Enable Notifications', notifPrimeLater:'Maybe Later',
      ...
      confFactory:'<strong style=\"color:var(--status-danger)\">This action cannot be undone.</strong><br><br><strong>What will be deleted:</strong><br>• All transactions, accounts, subscriptions, goals, debts<br>• Locally stored data on this device<br>• All data linked to your cloud key<br><br><span style=\"color:var(--text-muted);font-size:13px\"><strong>Note:</strong> Your key itself is not deleted, but all data inside it will be gone. Even if you use the same key on another device, the data cannot be recovered.</span><br><br>Do you want to continue?',
      confNotifPerm:'SAGI Finance can send reminders for subscriptions, debt deadlines, and budget alerts. Allow notifications?',
      confCloudCreate:'Your local data will be uploaded to Firebase under an anonymous key and sync will begin.\n\n Save your key — if you lose it, you will not be able to access your cloud data again.\n\nAs stated in our Privacy Policy, no identity information is collected. Continue?',
      confCloudSignOut:'Cloud connection will be disconnected on this device. Your data will remain here. Continue?',
      confFullLogout:'<strong style="color:var(--status-danger)">You will be signed out and all local data on this device will be deleted.</strong><br><br>Your cloud key and the data inside it are <strong>not deleted</strong> — if you saved your key, you can reconnect anytime with "Connect to Existing Account".<br><br>Do you want to continue?',
      fullLogoutDone:'Signed out, device reset.',
      keyNotFoundTitle:'Cloud Key Not Found',
      keyNotFoundDesc:'The cloud key registered on this device could not be found in Firebase. The account may have been deleted or removed elsewhere. You need to disconnect this device to continue.',
      keyNotFoundBtn:'Sign Out',
      ...
      confCloudConnectBothHaveData:'This account also has data. Connecting will <strong>delete your current local data</strong> and load the account\'s data instead. Continue?',
      ...
      payoffTimelineTitle:'Installment / Debt Payoff Timeline',
      payoffTimelineSubtitle:'How your credit card installment burden will decrease over the next 6 months',
      payoffNoInstallments:'No active installments — nothing to chart.',
      payoffMonthlyBurden:'Monthly Installment Burden',
      payoffMonthlyBurdenNow:'This Month\'s Installment Burden',
      payoffRemainingInstallments:'Total Remaining Installments',
      payoffTotalDebt:'Total Debt',
      forecastNet:'Net', forecastProjectedSuffix:'projected',
      netWorthTrendTitle:'Net Worth Trend',
      netWorthTrendSubtitle:'How your total assets have changed over time',
      netWorthTrendSeriesLabel:'Total Assets',
      netWorthTodayLabel:"Today's Net Worth",
      netWorthTodayHint:'Calculated as total assets minus debts and remaining installments. The chart shows assets (wallet balances) only; past debt levels cannot be reliably reconstructed, so they are not included in the chart.',
      burdenSummaryTitle:'Fixed Burden & Anomaly Summary',
      burdenSummarySubtitle:'Your subscription and installment burden, unusual category spending',
      burdenTotalLabel:'Monthly Fixed Burden', burdenOfIncome:'of income',
      anomalyTitle:'Unusual Spending',
      anomalyNone:'No unusual category spending detected this month.',
      anomalyRowText:(vars)=>`${vars.cat}: %${vars.pct} above the last 3-month average`,
      weekdayPatternTitle:'Day-of-Week Pattern', weekdayPatternHint:'Which days you spend the most on',
      weekdayShortNames:'Mon,Tue,Wed,Thu,Fri,Sat,Sun',
      biggestTxTitle:'Biggest Expenses', biggestTxHint:'The 8 largest transactions this period',
      ...
      notifSettingsBtn:'Notification Settings',
      ...
      obConsentSuffix:'. I have read and accept both. I confirm I am at least 18 years old.',
